...
if ($curr_version <> '1.2.5' && $curr_version <> '1.2.6' && $curr_version <> '1.2.7') {
    set_time_limit(0);
    ...
    tblSetColumnValue('#__jobboard_config', 'release_ver', '1.2.7.free');
}
if ($curr_version <> '1.2.7') tblSetColumnValue('#__jobboard_config', 'release_ver', '1.2.7');
$curr_version = tblCheckColumnValue('#__jobboard_config', 'release_ver', ' WHERE id=1');
...
<?php $rows = 0; ?>
    ...
    <a href="<?php echo JFilterOutput::AmpReplace('index.php?option=com_jobboard&view=config') ?>"><?php echo JText::_('COM_JOBBOARD_WELCOME_MSG3'); ?></a>
    <br />
    <br />
