...
<?php else : ?>
    ...
    <form method="post" action="<?php echo JRoute::_($path); ?>" id="applFRM" name="applFRM" enctype="multipart/form-data">
        <div id="aplpwrapper">
            ...
            <h3><?php echo $this->data->job_title;
                if ($this->config->use_location == 1) {
                    if ($this->data->country_name <> 'COM_JOBBOARD_DB_ANYWHERE_CNAME') echo ' - ' . $this->data->city; else echo ' - ' . JText::_('WORK_FROM_ANYWHERE');
                } ?></h3>
        ...
        <input name="option" value="com_jobboard" type="hidden" /> <input name="view" value="upload" type="hidden" />
