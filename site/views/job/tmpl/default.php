    ...
    <?php if ($this->config->show_job_summary == 1) : ?>
        <div id="jobsumm">
            ...
            <?php if ($this->config->use_location == 1) : ?>
                <div class="jsrow">
                    ...
                    <?php if ($this->config->enable_post_maps && ($this->data->country <> 266)) : ?>
                        ...
                        <?php if ($map_coded) : ?>
                            <small>
                                <a href="#" id="sb_view_map" class="map_trigger right jbrd-mright3"><?php echo JText::_('COM_JOBBOARD_SHOWMAP'); ?></a>
                            </small>
                        <?php endif ?>
                    <?php endif ?>
            ...
            <div id="sb_lastrow">
                ...
                <?php endif; ?>
                <br />
                <small><a href="<?php echo JRoute::_($back) ?>"><b>&#171;&nbsp;</b><?php echo $return; ?></a>
                </small>
            </div>
        </div>
    <?php endif; ?>
        ...
        <div id="jobcontent">
            <?php if ($this->config->show_viewcount == 1 || $this->config->show_applcount == 1) : ?>
                <div id="hitsumm">
                    ...
                    <small id="hsback">
                        <a href="<?php echo JRoute::_($back) ?>"><b>&#171;&nbsp;</b><?php echo $return; ?></a>
                    </small>
                </div>
            <?php endif; ?>
            <div id="bookmrk">
         ...
         <?php endforeach; ?>
            ...
            <?php if (!$this->is_modal) : ?>
                <?php if ($this->config->enable_post_maps && ($this->config->use_location == 1 && $this->data->country <> 266 && $this->data->geo_latitude <> '')) : ?>
                    <?php if (empty($this->rformat)) : ?>
                        ...
                        <?php if ($map_coded) : ?>
                            <br />
                            <a href="#" id="view_map" class="map_trigger right"><?php echo JText::_('COM_JOBBOARD_SHOWMAP'); ?></a>
                            <br class="clear" />
                            <a href="#" id="map_cls" class="right jbhidden"><?php echo JText::_('COM_JOBBOARD_HIDEMAP'); ?></a>
                            <br class="clear" />
                                    ...
                                    Tandolin.jobFe.Job = new TandolinPublcJob({
                                        jobData: {
                                            'lat': <?php echo $this->data->geo_latitude.',' ?>
                                                'lng'
                                : <?php echo $this->data->geo_longitude.',' ?>
                                    'title'
                                : <?php echo '"'.$this->data->job_title.'"' ?>
                                }
                                })
                                ;
                                }
            ...
            <div id="divbottom">
                ...
                <?php if ($this->config->show_job_summary == 0 && $this->config->send_tofriend == 1) : ?>
                    <a href="<?php echo JRoute::_($share); ?>">
                        <small><?php echo JText::_('EMAIL_TO_A_FRIEND'); ?></small>
                    </a>&nbsp;&nbsp;
                <?php endif; ?>
                <div class="lsretrn">
                    <small><a href="<?php echo JRoute::_($back) ?>"><b>&#171;&nbsp;</b><?php echo $return; ?></a>
                ...
                <?php if ($this->config->show_social == 1) : ?>
                    <?php if ($this->config->social_icon_style == 1) : ?>
                        ...
                        <div class="socialrow">
                            ...
                            <div class="fb-like" data-href="<?php echo $this->uri ?>" data-send="true" data-layout="button_count" data-width="450" data-show-faces="false"></div>
                    ...
                    <?php if ($this->config->social_icon_style == 0) : ?>
                        <a target="_blank" href="<?php echo $LinkedIn_long; ?>" title="<?php echo JText::_('LINKEDIN_SHARE') ?>">
                            <div id="linkedin">&nbsp;</div>
                        </a>
                        <a target="_blank" href="<?php echo $Twitter_long; ?>" title="<?php echo JText::_('TWITTER_SHARE') ?>">
                            <div id="twitter">&nbsp;</div>
                        </a>
                        <a target="_blank" href="<?php echo $FB_long; ?>" title="<?php echo JText::_('FACEBOOK_SHARE') ?>">
                            <div id="facebook">&nbsp;</div>
                        </a>
                    <?php endif; ?>
                <?php endif; ?>
