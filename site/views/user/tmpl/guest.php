        ...
        <div id="aplpwrapper">
            ...
            <h3><?php echo $this->data->job_title;
                if ($this->config->use_location == 1) {
                    if ($this->data->country_name <> 'DB_ANYWHERE_CNAME') echo ' - ' . $this->data->city; else echo ' - ' . JText::_('WORK_FROM_ANYWHERE');
                } ?></h3>
            ...
            <div <?php if ($this->config->appl_job_summary == 1) echo 'id="contleft"'; ?>>
                ...
                <div class="controw">
                    ...
                    <div id="fslabel">
                        <small>
                            <strong><?php echo JText::_('NB'); ?>:</strong><?php echo '&nbsp;' . JText::_('UPLOAD_ONLY_FORMATTYPES'); ?>
                        </small>
                    </div>
                </div>
