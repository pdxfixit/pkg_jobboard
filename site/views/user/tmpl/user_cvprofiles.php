...
<div id="cvprofs">
            ...
            <?php foreach ($this->profiles as $profile) : ?>
                <li class="line">
                    <ul class="row">
                      ...
                      <?php if ($profile->profile_hits > 0) : ?><?php echo JText::_('COM_JOBBOARD_ENT_VIEWS') ?>
                          <strong><?php echo $profile->profile_hits ?></strong>  |  <?php endif ?><?php echo JText::_('COM_JOBBOARD_CVPROF_MODON') ?>
                                    <strong><?php echo JHTML::_('date', $profile->modified_date, $this->day_format . ' ' . $this->month_short_format . ', ' . $this->year_format) ?></strong><br />
                                    <?php echo JText::_('COM_JOBBOARD_CVPROF_CREATEDON') ?>
                                    <strong><?php echo JHTML::_('date', $profile->created_date, $this->day_format . ' ' . $this->month_short_format . ', ' . $this->year_format) ?></strong> | <?php echo JText::_('COM_JOBBOARD_AVAILSTART') ?>
                                    <strong><?php echo JHTML::_('date', $profile->avail_date, $this->day_format . ' ' . $this->month_short_format . ', ' . $this->year_format) ?></strong>
                    </span> </a>
                        </li>
                        <li class="buttons">
    ...
    <?php if ($numrows > 0) : ?>
        ...
        <span class="jbPagination"><?php echo $this->pagination->getPagesLinks() ?><!--  --></span>
        <div class="clear">&nbsp;</div>
    <?php endif ?>
</div>