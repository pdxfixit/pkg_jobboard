    ...
    <div class="widecol">
        <div id="cvpreview">
            ...
            <form id="frmedit_1" method="post" action="<?php echo JRoute::_('index.php?option=com_jobboard&view=user&task=editcv&profileid=' . $this->cv_data->id) ?>">
                ...
                <input type="hidden" name="view" value="user" /> <input type="hidden" name="task" value="editcv" />
                <input type="hidden" name="profileid" value="<?php echo $this->cv_data->id ?>" />
                <input type="hidden" name="emode" value="1" /> <input type="hidden" name="getdata" value="0" />
                <input type="hidden" name="step" value="1" />
                <?php echo JHTML::_('form.token'); ?>
            </form>
            <p>
                <small><?php echo JText::_('COM_JOBBOARD_AVAILSTART') . ' ' . JHTML::_('date', $this->cv_data->avail_date, $this->day_format . ' ' . $this->month_short_format . ', ' . $this->year_format) ?></small>
            </p>
            <br />
            ...
            <div class="item">
                ...
                <form id="frmedit_2" method="post" action="<?php echo JRoute::_('index.php?option=com_jobboard&view=user&task=editcv&profileid=' . $this->cv_data->id) ?>">
                    ...
                    <input type="hidden" name="view" value="user" /> <input type="hidden" name="task" value="editcv" />
                    <input type="hidden" name="profileid" value="<?php echo $this->cv_data->id ?>" />
                    <input type="hidden" name="emode" value="1" /> <input type="hidden" name="getdata" value="1" />
                    <input type="hidden" name="step" value="3" /> <input type="hidden" name="section" value="summary" />
                    <?php echo JHTML::_('form.token'); ?>
                </form>
            ...
            <div class="item">
                ...
                <form id="frmedit_3" method="post" action="<?php echo JRoute::_('index.php?option=com_jobboard&view=user&task=editcv&profileid=' . $this->cv_data->id) ?>">
                    ...
                    <input type="hidden" name="profileid" value="<?php echo $this->cv_data->id ?>" />
                    <input type="hidden" name="emode" value="1" /> <input type="hidden" name="getdata" value="1" />
                    <input type="hidden" name="step" value="3" /> <input type="hidden" name="section" value="skills" />
                    <?php echo JHTML::_('form.token'); ?>
                </form>
                    ...
                    <?php foreach ($this->cv_data->employers as $employer) : ?>
                        ...
                        <p class="period">
                            ...
                            <?php if ($e_start_year <> '' && $e_end_year <> '') : ?>
                                <abbr class="dtstart" title="<?php echo $employer->start_yr ?>"><?php echo $e_start_year ?></abbr>&nbsp;&ndash;&nbsp;
                                <abbr class="dtstamp" title="<?php echo $employer->end_yr ?>"><?php echo $empl_stat ?></abbr>
                            <?php endif ?>
                        </p>
                    <?php endforeach ?>
                <?php endif ?>
