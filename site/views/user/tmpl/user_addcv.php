...
$curmonth = $this->av_date->toFormat("%B");
$curday = $this->av_date->toFormat("%d"); ?>
<?php $day_str = $curday . '/' . $curmonth . '/' . $curyear; ?>
<?php $curmonth_nr = $this->av_date->toFormat("%m"); ?>
<?php $lastday = date('t', strtotime($day_str));
$get_li_prof = JFilterOutput::ampReplace(JURI::root() . 'index.php?option=com_jobboard&view=user&task=getlinkedinprof&Itemid=' . $this->itemid); ?>
...
<?php switch ($this->step) {
    ...
    <?php endif ?>
        <div class="nopaddiv">
            ...
            <select id="available_yyyy" name="available_yyyy">
                ...
                <?php endfor; ?>
            </select> <select id="available_mm" name="available_mm" tabindex="40">
                <?php for ($i = 1; $i < 13; $i++) : ?>
                ...
                <?php endfor; ?>
            </select> <select id="available_dd" name="available_dd" tabindex="30">
        ...
        <div class="clear">&nbsp;</div>
        <span id="filesInfo" class="frmheading"><?php echo JText::_('COM_JOBBOARD_UPLOADSDESCR') ?>
            <small class="right fnrml"><?php echo JText::_('COM_JOBBOARD_MAXSIZE') . ' ' . $this->config->max_filesize . JText::_('COM_JOBBOARD_MEGABYTESEACH') ?></small></span>
        <div id="filerow-1" class="filerow">
            <label><?php echo JText::_('TITLE') ?></label> <input type="text" size="55" name="filetitle[1]" />
    ...
    <?php endif ?>
        ...
        <div id="edRow-1" class="qualrow first">
            <label><?php echo JText::_('COM_JOBBOARD_HIGHESTQUAL') ?></label> <select name="edtype[1]">
                ...
                <?php endforeach; ?>
            </select> <label><?php echo JText::_('COM_JOBBOARD_QUALNAME') ?></label>
            ...
            <label><?php echo JText::_('COM_JOBBOARD_TXTCOUNTRY') ?></label> <select name="edu_country[1]">
                <?php foreach ($this->countries as $country) : ?>
                    <?php if ($country->country_id == 266) : ?>
                        <option value="<?php echo $country->country_id ?>" <?php if ($country->country_id == $this->edu_data[0]->edu_country) {
                            echo 'selected="selected"';
                        } ?>><?php echo JText::_('COM_JOBBOARD_DB_ANYWHERE_CNAME'); ?></option>
                    <?php else: ?>
                        <option value="<?php echo $country->country_id ?>" <?php if ($country->country_id == $this->edu_data[0]->edu_country) {
                            echo 'selected="selected"';
                    ...
                    <?php endif; ?>
                <?php endforeach; ?>
            </select> <label><?php echo JText::_('COM_JOBBOARD_TXTCITY') ?></label>
            ...
            <select name="ed_year[1]" class="infoRight clrright">
                ...
                <?php endfor; ?>
            </select> <input type="hidden" name="edu_id[1]" value="<?php echo $this->edu_data[0]->id ?>" />
        </div>
        ...
        <?php if (count($this->edu_data) > 0) : ?>
            ...
            <?php foreach ($this->edu_data as $edu) : ?>
                <div id="edRow-<?php echo $ed_iterator ?>" class="qualrow">
                 <span class="qualheading">
                  <?php echo JText::_('EDUCATION') . ' ' . $ed_iterator ?>
                 ...
                 </span> <label><?php echo JText::_('COM_JOBBOARD_TXTTYPE') ?></label>
                    ...
                    <select name="edu_country[<?php echo $ed_iterator ?>]">
                        <?php foreach ($this->countries as $country) : ?>
                            <?php if ($country->country_id == 266) : ?>
                                <option value="<?php echo $country->country_id ?>" <?php if ($country->country_id == $edu->edu_country) {
                                    echo 'selected="selected"';
                                } ?>><?php echo JText::_('COM_JOBBOARD_DB_ANYWHERE_CNAME'); ?></option>
                            <?php else: ?>
                                <option value="<?php echo $country->country_id ?>" <?php if ($country->country_id == $edu->edu_country) {
        ...
        <?php if ($this->section == 'education' || $this->section <> 'employer') : ?>
            <div id="edRow-1" class="qualrow first">
                ...
                <label><?php echo JText::_('COM_JOBBOARD_TXTCOUNTRY') ?></label> <select name="edu_country[1]">
                    <?php foreach ($this->countries as $country) : ?>
                        <?php if ($country->country_id == 266) : ?>
                            <option value="<?php echo $country->country_id ?>" <?php if ($country->country_id == $this->config->default_country) {
                                echo 'selected="selected"';
                            } ?>><?php echo JText::_('COM_JOBBOARD_DB_ANYWHERE_CNAME'); ?></option>
                        <?php else: ?>
                            <option value="<?php echo $country->country_id ?>" <?php if ($country->country_id == $this->config->default_country) {
    ...
    <?php endif ?>
        ...
        <div id="employer-1" class="emplrow first">
            ...
            <label><?php echo JText::_('COM_JOBBOARD_TXTCOUNTRY') ?></label> <select name="employer_country[1]">
                <?php foreach ($this->countries as $country) : ?>
                    <?php if ($country->country_id == 266) : ?>
                        <option value="<?php echo $country->country_id ?>" <?php if ($country->country_id == $this->empl_data[0]->country_id) {
                            echo 'selected="selected"';
                        } ?>><?php echo JText::_('COM_JOBBOARD_DB_ANYWHERE_CNAME'); ?></option>
                    <?php else: ?>
                        <option value="<?php echo $country->country_id ?>" <?php if ($country->country_id == $this->empl_data[0]->country_id) {
            ...
            <div class="nopaddiv">
                <select name="endyear[1]" class="infoRight first" tabindex="911">
                    ...
                    <?php endfor; ?>
                </select> <label class="rightlabel"><?php echo JText::_('COM_JOBBOARD_END') ?></label>
                <select name="startyear[1]" class="infoRight" tabindex="911">
                    ...
                    <?php endfor; ?>
                </select> <select name="startmon[1]" tabindex="40">
                    <?php for ($m = 1; $m < 13; $m++) : ?>
                        <?php $month_leading = sprintf("%02d", $m) ?>
                        <?php $month_string = $curyear . '-' . $month_leading . '-' . $curday ?>
                ...
                <span class="chk_wrapper">
                    <?php echo JText::_('COM_JOBBOARD_ISCURRENT_EMPL') ?>
                    <input class="chk_empl" type="checkbox" name="empl_iscurrent[1]" value="yes" checked="checked" />
                </span>
            </div>
        ...
        <?php if (count($this->empl_data) > 0) : ?>
            ...
            <?php foreach ($this->empl_data as $empl) : ?>
                <div id="employer-<?php echo $empl_iterator ?>" class="emplrow">
                    ...
                    </span> <label><?php echo JText::_('COM_JOBBOARD_TXTCOMPANY') ?></label>
                    ...
                    <select name="employer_country[<?php echo $empl_iterator ?>]">
                        <?php foreach ($this->countries as $country) : ?>
                            <?php if ($country->country_id == 266) : ?>
                                <option value="<?php echo $country->country_id ?>" <?php if ($country->country_id == $empl->country_id) {
                                    echo 'selected="selected"';
                                } ?>><?php echo JText::_('COM_JOBBOARD_DB_ANYWHERE_CNAME'); ?></option>
                            <?php else: ?>
                                <option value="<?php echo $country->country_id ?>" <?php if ($country->country_id == $empl->country_id) {
                    ...
                    <div class="nopaddiv">
                        <select name="endyear[<?php echo $empl_iterator ?>]" class="infoRight first" tabindex="911">
                            ...
                            <?php for ($i = 0; $i <= 40; $i++) : ?>
                                <option value="<?php echo $curyear - $i ?>" <?php if ($empl_end_year == ($curyear - $i)) echo 'selected="selected"' ?> ><?php echo $curyear - $i ?></option>
                            <?php endfor; ?>
                        </select> <select name="endmon[<?php echo $empl_iterator ?>]">
                            <?php for ($m = 1; $m < 13; $m++) : ?>
                                <?php $month_leading = sprintf("%02d", $m) ?>
                                <?php $month_string = $curyear . '-' . $month_leading . '-' . $curday ?>
                                <option value="<?php echo $month_leading ?>" <?php if ($empl_end_month == $month_leading) echo 'selected="selected"' ?>><?php echo JHTML::_('date', $month_string, $this->month_short_format) ?></option>
                        ...
                        <select name="startyear[<?php echo $empl_iterator ?>]" class="infoRight" tabindex="911">
                            ...
                            <?php for ($i = 0; $i <= 40; $i++) : ?>
                                <option value="<?php echo $curyear - $i ?>" <?php if ($empl_start_year == ($curyear - $i)) echo 'selected="selected"' ?> ><?php echo $curyear - $i ?></option>
                            <?php endfor; ?>
                        </select> <select name="startmon[<?php echo $empl_iterator ?>]" tabindex="40">
                            <?php for ($m = 1; $m < 13; $m++) : ?>
                                <?php $month_leading = sprintf("%02d", $m) ?>
                                <?php $month_string = $curyear . '-' . $month_leading . '-' . $curday ?>
                                <option value="<?php echo $month_leading ?>" <?php if ($empl_start_month == $month_leading) echo 'selected="selected"' ?>><?php echo JHTML::_('date', $month_string, $this->month_short_format) ?></option>
                      ...
                      <span class="chk_wrapper">
                          <?php echo JText::_('COM_JOBBOARD_ISCURRENT_EMPL') ?>
                          <input class="chk_empl" type="checkbox" name="empl_iscurrent[<?php echo $empl_iterator ?>]" value="yes" <?php if ($empl->current == 1) echo 'checked="checked"' ?> />
                      </span>
                    </div>
    ...
    <?php else : ?>
        <?php if ($this->section == 'employer' || $this->section <> 'education') : ?>
            <div id="employer-1" class="emplrow first">
                ...
                <span class="chk_wrapper">
                    <?php echo JText::_('COM_JOBBOARD_ISCURRENT_EMPL') ?>
                    <input class="chk_empl" type="checkbox" name="empl_iscurrent[1]" value="1" checked="checked" />
                </span>
                </div>
            </div>
        <?php endif ?>
    ...
    case 3 :
        ...
        <span class="skillstxt"><?php echo JText::sprintf('COM_JOBBOARD_TXTSKILLSHEADER', $this->config->max_skills) ?>
            <small><?php echo JText::_('COM_JOBBOARD_SPACESONLY') ?></small></span>
        <div id="skillheader">
            ...
            <span class="skilllastuse"><?php echo JText::_('COM_JOBBOARD_SKILL_LASTUSE') ?></span>
                <span class="skillexpperiod"><?php echo JText::_('COM_JOBBOARD_EXPERIENCE') ?>
                    <small>(<?php echo JText::_('COM_JOBBOARD_SKILL_LU_INMO') ?>)</small></span>
        ...
        <?php if ($this->linkedin_arr['response'] === true) : ?>
            ...
            <?php if (is_array($this->linkedin_arr['positions']['position']) && intval($this->linkedin_arr['positions']['@attributes']['total']) > 0)   : ?>
                <div class="cvblock">
                    ...
                    <?php $now_str = $curyear . '-' . sprintf("%02d", $curmonth) . '-' . $curday;
                    $job_ctr = 0; ?>
                    <?php if (intval($this->linkedin_arr['positions']['@attributes']['total']) == 1)  : ?>
                        ...
                        <p class="period">
                            ...
                            <?php if ($this->linkedin_arr['positions']['position']['is-current'] && !isset($this->linkedin_arr['positions']['position']['end-date'])) {
                                $end_year_str = $now_str;
                                $end_year = JText::_('COM_JOBBOARD_TXTPRESENT');
                            } ?>
                            <?php if (isset($this->linkedin_arr['positions']['position']['end-date']) && is_array($this->linkedin_arr['positions']['position']['end-date'])) {
                                $end_year_str = $this->linkedin_arr['positions']['position']['end-date']['year'] . '-' . sprintf("%02d", $this->linkedin_arr['positions']['position']['end-date']['month']) . '-27';
                                $end_year = JHTML::_('date', $end_year_str, $this->month_long_format . ' ' . $this->year_format);
                            } ?>
                    ...
                    <?php else : ?>
                        <?php foreach ($this->linkedin_arr['positions']['position'] as $pos) : ?>
                            ...
                            <p class="period">
                                ...
                                <?php if ($pos['is-current'] && !isset($pos['end-date'])) {
                                    $end_year_str = $now_str;
                                    $end_year = JText::_('COM_JOBBOARD_TXTPRESENT');
                                } ?>
                                <?php if (isset($pos['end-date']) && is_array($pos['end-date'])) {
                                    $end_year_str = $pos['end-date']['year'] . '-' . sprintf("%02d", $pos['end-date']['month']) . '-27';
                                    $end_year = JHTML::_('date', $end_year_str, $this->month_long_format . ' ' . $this->year_format);
                                } ?>
                                <abbr title="<?php echo $start_year ?>" class="dtstart"><?php echo JHTML::_('date', $start_year, $this->month_long_format . ' ' . $this->year_format) ?></abbr>&nbsp;&ndash;&nbsp;<abbr title="<?php echo $end_year_str ?>" class="dtstamp"><?php echo $end_year ?></abbr>
                            </p>
                ...
                <div class="cvblock">
                    ...
                    <?php if (intval($this->linkedin_arr['educations']['@attributes']['total']) == 1) : ?>
                        ...
                        <p class="period">
                            ...
                            $start_year = "";
                            $end_year = ""; ?>
                            <?php if (isset($ed['start-date'])) $start_year = $ed['start-date']['year'];
                            $sep = "&nbsp;&ndash;&nbsp;"; ?>
...
<div id="btn_container_footer">
    ...
    <?php else: ?>
        ...
        <?php elseif ($this->editmode == 1) : ?>
            ...
            <small>
                <span class="btn"><a href="<?php echo JRoute::_('index.php?option=com_jobboard&view=user&task=viewcv&profileid=' . $this->profileid . $page_hash) ?>"><?php echo JText::_('COM_JOBBOARD_TXTCANCL') ?></a></span>
            </small>
    ...
    <?php if ($this->step == 1) : ?>
        <?php if ($this->editmode == 0) : ?>
            <small>
                <span class="btn"><a href="<?php echo JRoute::_('index.php?option=com_jobboard&view=user&task=cvprofs') ?>"><?php echo JText::_('COM_JOBBOARD_TXTCANCL') ?></a></span>
            </small>
        <?php endif ?>
    <?php endif ?>
</div>
<input type="hidden" name="option" value="com_jobboard" /> <input type="hidden" name="view" value="user" />
<input type="hidden" value="<?php echo $this->step + 1 ?>" name="step" id="step" />
<?php if ($this->linkedin_imported == 1 && $this->step == 4) {
    $this->profileid = 0;
    $this->editmode = 0;
    $this->getdata = 0;
} ?>
