...
<div id="user-profile-header">
    <ul id="ptabs">
        <li <?php if ($this->currtab == 1) echo 'class="active"' ?>>
            <a href="<?php echo JRoute::_('index.php?option=com_jobboard&view=user&task=prof&tab=1&Itemid=' . $this->itemid) ?>"><?php echo JText::_('COM_JOBBOARD_PROFILE') ?></a>
        </li>
        <li <?php if ($this->currtab == 2) echo 'class="active"' ?>>
            <a href="<?php echo JRoute::_('index.php?option=com_jobboard&view=user&task=prof&tab=2&Itemid=' . $this->itemid) ?>"><?php echo JText::_('COM_JOBBOARD_PICTURE') ?></a>
        </li>
        <li <?php if ($this->currtab == 5) echo 'class="active"' ?>>
            <a href="<?php echo JRoute::_('index.php?option=com_jobboard&view=user&task=prof&tab=5&Itemid=' . $this->itemid) ?>"><?php echo JText::_('COM_JOBBOARD_SETTINGS') ?></a>
        </li>
    </ul>
</div>
    ...
    case 1 :
        ...
        <div class="fieldrow">
            ...
            <div class="input">
                ...
                <p class="user-block small"><?php echo JText::_('COM_JOBBOARD_TXTUSERNAME') ?>:
                    <strong><?php echo $this->data->username ?></strong></p>
            </div>
        </div>
        <div class="fieldrow">
            ...
            <div class="input">
                <select id="contact_country" name="contact_country">
                    ...
                    <?php foreach ($this->countries as $country) : ?>
                        ...
                        <?php else: ?>
                            <option value="<?php echo $country->country_id ?>" <?php if ($country->country_id == $default_country) {
        ...
        <div class="fieldrow">
            ...
            <div class="input">
                ...
                <p class="user-block">
                    ...
                    <small><?php echo JText::sprintf('COM_JOBBOARD_TIP_PROFILE_NAME', JText::_('COM_JOBBOARD_LINKEDIN')) ?> '<strong>http://www.linkedin.com/in/<?php echo JText::_('COM_JOBBOARD_TIP_PROFILE_MYNAME') ?></strong>' <?php echo JText::sprintf('COM_JOBBOARD_TIP_PROFILE_NAMEONLY', '<strong>' . JText::_('COM_JOBBOARD_TIP_PROFILE_MYNAME') . '</strong>') ?>
                    </small>
                    )
                </p>
            </div>
        ...
        <div class="fieldrow">
            ...
            <div class="input">
                ...
                <p class="user-block">
                    <?php echo JText::_('COM_JOBBOARD_TIP_NAMEONLY') ?> <br />(
                    <small><?php echo JText::sprintf('COM_JOBBOARD_TIP_PROFILE_NAME', JText::_('COM_JOBBOARD_TWITTER')) ?> '<strong>http://www.twitter.com/<?php echo JText::_('COM_JOBBOARD_TIP_PROFILE_MYNAME') ?></strong>' <?php echo JText::sprintf('COM_JOBBOARD_TIP_PROFILE_NAMEONLY', '<strong>' . JText::_('COM_JOBBOARD_TIP_PROFILE_MYNAME') . '</strong>') ?>
                    </small>
                    )
                </p>
            </div>
        ...
        <div class="fieldrow">
            ...
            <div class="input">
                ...
                <p class="user-block">
                    <?php echo JText::_('COM_JOBBOARD_TIP_NAMEONLY') ?> <br />(
                    <small><?php echo JText::sprintf('COM_JOBBOARD_TIP_PROFILE_NAME', JText::_('COM_JOBBOARD_FACEBOOK')) ?> '<strong>http://www.facebook.com/<?php echo JText::_('COM_JOBBOARD_TIP_PROFILE_MYNAME') ?></strong>' <?php echo JText::sprintf('COM_JOBBOARD_TIP_PROFILE_NAMEONLY', '<strong>' . JText::_('COM_JOBBOARD_TIP_PROFILE_MYNAME') . '</strong>') ?>
                    </small>
                    )
                </p>
            </div>
