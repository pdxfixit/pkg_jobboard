...
<select id="available_yyyy" name="available_yyyy" tabindex="50">
    ...
    <?php endfor; ?>
</select><label for="job_type"><?php echo JText::_('COM_JOBBOARD_JOBTYPESOUGHT') ?></label>
...
<div class="clear">&nbsp;</div><span class="frmheading"><?php echo JText::_('COM_JOBBOARD_UPLOADSDESCR') ?>
...
</div><input type="hidden" name="file_count" id="file_count" value="<?php echo $this->file_count ?>" />
<div id="filesfooter">
