        ...
        <div <?php if ($this->config->sharing_job_summary == 1) echo 'id="contleft"'; ?>>
            <form method="post" action="<?php echo JRoute::_($path); ?>" id="shareFRM" name="shareFRM" enctype="multipart/form-data">
                <fieldset>
                    ...
                    <div class="controw">
                        <label for="sender_email"><?php echo JText::_('YOUR_EMAIL'); ?>
                    ...
                    <div class="controw">
                        <label for="sender_name"><?php echo JText::_('YOUR_FULL_NAME'); ?>
                            <span class="fieldreq"><?php echo $req_marker; ?></span></label>
                        <?php if (!$user->get('guest')) : ?>
                ...
                <fieldset>
                    ...
                    <div class="controw">
                        <label for="rec_emails"><?php echo JText::_('TO_EMAIL_ADDRESSES'); ?>
                            <span class="fieldreq"><?php echo $req_marker; ?></span></label>
                ...
                <div class="btnarea">
                    ...
                    <?php $sel_job = 'index.php?option=com_jobboard&view=job&id=' . $this->job_id . '&Itemid=' . $this->itemid; ?>
                    <a class="mleft10" href="<?php echo JRoute::_($sel_job); ?>"><?php echo JText::_('CANCEL'); ?></a>
                </div>
