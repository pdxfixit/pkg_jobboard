...
Tandolin.JobQuestionnaire = new Class({Implements: [Options, Events], options: {previewBase: "index.php?option=com_jobboard&view=questionnaire&id=", previewFormat: "component", qId: "questionnaire_id", previewLnk: "q-preview", hiddenClass: "hidden", nullUrl: "#"}, initialize: function (a) {
    this.setOptions(a);
