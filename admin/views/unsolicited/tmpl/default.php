...
<form action="index.php?option=com_jobboard" method="post" name="adminForm" id="adminForm">
    <fieldset id="filter-bar">
        <table width="100%">
            ...
            <tr>
                <td align="left">
                    <?php echo JText::_('COM_JOBBOARD_SEARCH'); ?>:
            ...
            <tr class="<?php echo "row$k"; ?>">
                ...
                <td align="center">
                    ...
                    <?php switch ($this->config->long_date_format) {
                        case 0:
                            echo JHTML::_('date', $row->request_date, $this->day_format . ' ' . $this->month_long_format . ', ' . $this->year_format);
                            break;
                        case 1:
                            echo JHTML::_('date', $row->request_date, $this->month_long_format . ' ' . $this->day_format . ', ' . $this->year_format);
                            break;
                        case 2:
                            echo JHTML::_('date', $row->request_date, $this->year_format . ', ' . $this->day_format . ' ' . $this->month_long_format);
                            break;?>
                        <?php
                    }; ?>
                </td>
