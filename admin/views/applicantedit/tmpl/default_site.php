        ...
        <fieldset class="adminform">
            ...
            <table class="admintable">
                <tr>
                    ...
                    <td>
                        <a href="<?php echo JFilterOutput::ampReplace('index.php?option=com_jobboard&view=jobs&task=edit&cid[]=' . $this->row->job_id); ?>"><strong> <?php echo $this->row->job_title; ?></strong>
                        </a>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <a href="<?php echo JFilterOutput::ampReplace('index.php?option=com_jobboard&view=jobs&task=edit&cid[]=' . $this->row->job_id); ?>"><strong> <?php echo $this->row->job_id; ?></strong>
                        </a>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        ...
                        <?php switch ($this->config->long_date_format) {
                            case 0:
                                echo JHTML::_('date', $this->row->post_date, $this->day_format . ' ' . $this->month_long_format . ', ' . $this->year_format);
                                break;
                            case 1:
                                echo JHTML::_('date', $this->row->post_date, $this->month_long_format . ' ' . $this->day_format . ', ' . $this->year_format);
                                break;
                            case 2:
                                echo JHTML::_('date', $this->row->post_date, $this->year_format . ', ' . $this->day_format . ' ' . $this->month_long_format);
                                break;?>
                            <?php
                        }; ?>
                    </td>
            ...
            <table class="admintable">
                <tr>
                    ...
                    <td>
                        ...
                        <?php switch ($this->config->long_date_format) {
                            case 0:
                                echo JHTML::_('date', $this->row->request_date, $this->day_format . ' ' . $this->month_long_format . ', ' . $this->year_format);
                                break;
                            case 1:
                                echo JHTML::_('date', $this->row->request_date, $this->month_long_format . ' ' . $this->day_format . ', ' . $this->year_format);
                                break;
                            case 2:
                                echo JHTML::_('date', $this->row->request_date, $this->year_format . ', ' . $this->day_format . ' ' . $this->month_long_format);
                                break;?>
                            <?php
                        }; ?>
                    </td>
                    ...
                    <td>
                        <select name="status">
                            <?php foreach ($this->statuses as $status) : ?>
                                <option value="<?php echo $status->id ?>" <?php if ($status->id == $this->row->status) {
                                    echo 'selected="selected"';
                                } ?>><?php echo $status->status_description; ?></option>
                            <?php endforeach; ?>
                        </select> &nbsp;&nbsp;<a href="<?php echo JFilterOutput::ampReplace('index.php?option=com_jobboard&amp;&view=statuses') ?>"><?php echo JText::_('COM_JOBBOARD_ED_STATUS_CHOICES') ?></a>
                    </td>
                </tr>
                <tr>
                    <td align="right" class="key">
                    ...
                    <td>
                        ...
                        <?php else : ?>
                            ...
                            <?php switch ($this->config->long_date_format) {
                                case 0:
                                    echo JHTML::_('date', $this->row->last_updated, $this->day_format . ' ' . $this->month_long_format . ', ' . $this->year_format);
                                    break;
                                case 1:
                                    echo JHTML::_('date', $this->row->last_updated, $this->month_long_format . ' ' . $this->day_format . ', ' . $this->year_format);
                                    break;
                                case 2:
                                    echo JHTML::_('date', $this->row->last_updated, $this->year_format . ', ' . $this->day_format . ' ' . $this->month_long_format);
                                    break;?>
                                <?php
                            }; ?>
                        <?php endif; ?>
                    ...
                    <td>
                        <select name="department">
                            <?php foreach ($this->departments as $department) : ?>
                                <option value="<?php echo $department->id ?>" <?php if ($department->id == $this->row->department) {
                                    echo 'selected="selected"';
                                    $job_department = $department;
                                } ?>><?php echo $department->name; ?></option>
                            <?php endforeach; ?>
                        </select> &nbsp;&nbsp;<a href="index.php?option=com_jobboard&amp;&view=departments"><?php echo JText::_('COM_JOBBOARD_EDIT_DEPTS') ?></a>
                    </td>
                </tr>
            </table>
        </fieldset>
...
<?php endif ?>
    <script language="javascript" type="text/javascript">
        ...
        function encHtml(h) {
            encdHtml = escape(h);
            encdHtml = encdHtml.replace(/\//g, "%2F");
            encdHtml = encdHtml.replace(/\?/g, "%3F");
            encdHtml = encdHtml.replace(/=/g, "%3D");
            encdHtml = encdHtml.replace(/&/g, "%26");
            encdHtml = encdHtml.replace(/@/g, "%40");
            return encdHtml;
        }
    </script>
