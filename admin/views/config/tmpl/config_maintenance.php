...
<div style="width:100%">
    ...
    <table class="admintable config left">
        ...
        <tr>
            <td colspan="2">
                <?php echo JText::_('COM_JOBBOARD_MAINT_LAST_RUN'); ?>&nbsp;&bull;&nbsp; <strong>
    ...
    <table class="admintable config right">
        ...
        <tr>
            <td class="key">
                <?php echo JText::sprintf('COM_JOBBOARD_MAINT_TASKS_NOTIF_MAILTO', ''); ?>&nbsp;
                <small><?php echo $this->row->from_mail ?></small>
            </td>
            <td>
