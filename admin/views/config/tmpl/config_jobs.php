...
<table class="admintable config right">
    ...
    <tr>
        ...
        <td>
            <select name="social_icon_style">
                <option value="0" <?php if ($this->row->social_icon_style == 0) {
                    echo 'selected="selected"';
                } ?>><?php echo JText::_('COM_JOBBOARD_SOCIAL_ICONS_SMALL'); ?></option>
                <option value="1" <?php if ($this->row->social_icon_style == 1) {
                    echo 'selected="selected"';
                } ?>><?php echo JText::_('COM_JOBBOARD_SOCIAL_ICONS_COUNTERS'); ?></option>
            </select>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        <td class="configsectionhead" colspan="2"><?php echo JText::_('COM_JOBBOARD_JOBSUMM_SETTINGS'); ?><br />
            <small><?php echo ' <i>(' . JText::_('COM_JOBBOARD_SHOW_JOBSUMM_ONVIEW') . ':)</i>'; ?></small>
        </td>
    </tr>
    <tr>
        <td align="right" class="key">
