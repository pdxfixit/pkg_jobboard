...
?>
    ...
    <div id="noticebox" style="border: 1px dotted #ccc; width: 40%; padding: 10px; float: right;">
        ...
        <h3><?php echo JText::_('') ?> </h3></p><p><?php echo JText::_('COM_JOBBOARD_NOTE_P1') ?>:</p>
        <ul>
        ...
        <p><?php echo JText::_('COM_JOBBOARD_NOTE_P6') ?> <a href="http://bit.ly/kon-da" target="_new">Kon</a> &amp;
            <a href="http://bit.ly/ot-blog" target="_new">Oliver Twardowski</a></p>
    </div>
