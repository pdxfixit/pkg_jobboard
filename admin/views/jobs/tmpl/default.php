                ...
                <td align="center">
                    ...
                    <?php switch ($this->config->long_date_format) {
                        case 0:
                            ...
                            break;
                        case 1:
                            echo JHTML::_('date', $row->post_date, $this->month_short_format . ' ' . $this->day_format . ', ' . $this->year_format);
                            break;
                        case 2:
                            echo JHTML::_('date', $row->post_date, $this->year_format . ', ' . $this->day_format . ' ' . $this->month_short_format);
                            break;?>
                        <?php
                    }; ?>
                </td>
